    ...
    public class KafkaSimpleProducer {
        public static void main(String[] args) throws Exception {
           ...
           // String jsons =  new String(encoded, Charset.defaultCharset());
            ...
            List<String> splittedJsons = new LinkedList<>();
            
            splittedJsons.add("{\"phonetype\":\"N95\",\"cat\":\"WP\"}");
           
            splittedJsons.add("{\"phonetype\":\"N96\",\"cat\":\"WP\"}");
            splittedJsons.add("{\"phonetype\":\"N97\",\"cat\":\"WP\"}");
            splittedJsons.add("{\"phonetype\":\"N98\",\"cat\":\"WP\"}");
            splittedJsons.add("{\"phonetype\":\"N99\",\"cat\":\"WP\"}");
